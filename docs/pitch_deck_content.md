...
| Paid users (EOY) | 500 | 2,500 | 8,000 |
| Blended ARPU | $30 | $35 | $40 |
| **MRR (EOY)** | **$15,000** | **$87,500** | **$320,000** |
| **ARR (EOY)** | **$180,000** | **$1,050,000** | **$3,840,000** |

**Cost Structure (Year 1):**

| Hạng mục | Chi phí/tháng | % |
|---|---|---|
| LLM API costs (Gemini, Groq) | $800–1,500 | 15% |
| Cloud infrastructure | $300–500 | 7% |
| Team salaries (3–4 người) | $3,000–4,000 | 55% |
| Marketing & Growth | $500–1,000 | 13% |
| Miscellaneous | $300–500 | 10% |
| **Tổng burn/tháng** | **~$5,000–7,500** | 100% |

**Path to Profitability:**
- **Breakeven point:** ~250–300 paid users (MRR ≈ $8,500–10,500)
- **Dự kiến đạt breakeven:** Q2–Q3/2027 (tháng 12–15)
- **Gross margin tại scale:** 83–88% (LLM cost giảm nhờ caching, batching, và model optimization)
...
### Raise: $100,000–$150,000 (Pre-Seed)

**Dùng vào đâu:**

| Hạng mục | Tỷ lệ | Mục đích |
|---|---|---|
| Engineering & Product | 45% | Hire 1 AI engineer + 1 designer, tối ưu pipeline |
| Go-to-Market | 25% | Content marketing, community building, partnership |
| Infrastructure | 15% | Cloud, LLM API costs, monitoring |
| Operations & Buffer | 15% | Legal, accounting, contingency |

**Runway:** 12–15 tháng với burn rate $7,000–10,000/tháng

**Milestones sau round này:**

| Timeline | Milestone |
|---|---|
| +3 tháng | 1,000 registered users, 80 paid, product-market fit validated |
| +6 tháng | 3,000 users, 200 paid, MRR $7,000 |
| +9 tháng | Partnership với 2+ incubators, B2B pilot started |
| +12 tháng | 5,000 users, 500 paid, MRR $15,000, ready for Seed round |

**Kỳ vọng Seed Round (12–15 tháng sau):**
- Raise: $500K–$1M
- Valuation target: $3M–$5M
- Mục tiêu: Scale sang Đông Nam Á (bắt đầu từ Indonesia, Philippines)
