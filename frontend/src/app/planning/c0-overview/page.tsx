    ...
    <>
      ...
      >
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-fuchsia-600 to-purple-700 rounded-xl p-8 text-white shadow-md relative overflow-hidden">
             <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -mr-20 -mt-20"></div>
             <h2 className="text-2xl font-bold mb-3 relative z-10">Mục tiêu của Phần C là gì?</h2>
             <p className="text-fuchsia-50 leading-relaxed max-w-3xl relative z-10 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
                ...
                <h3 className="font-bold text-slate-800 mb-2">Tầm nhìn HQ</h3>
                <p className="text-sm text-slate-500">Giới hạn định hướng vĩ mô bao trùm mọi nhãn hiệu trực thuộc.</p>
             </div>
             <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
                <div className="w-12 h-12 bg-pink-50 text-pink-600 rounded-full flex items-center justify-center mb-4">
                  <Network className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-slate-800 mb-2">Giải quyết Cộng hưởng</h3>
                <p className="text-sm text-slate-500">Đôi khi vấn đề kho bãi của SBU này lại là dư thừa của SBU kia.</p>
             </div>
             <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
                <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mb-4">
                  <BarChart3 className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-slate-800 mb-2">Executive Dashboard</h3>
                <p className="text-sm text-slate-500">Xem nhanh chỉ số sức khỏe của mọi SBU chỉ với 1 bảng gộp duy nhất.</p>
             </div>
          </div>
