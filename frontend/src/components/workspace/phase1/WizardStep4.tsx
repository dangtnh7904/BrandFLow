...
export default function WizardStep4() {
 ...
 <h2 className="text-2xl font-bold text-foreground mb-2">{t('wizard.step4_title')}</h2>
 <p className="text-linear-text-muted text-sm max-w-lg mx-auto">{t('wizard.step4_desc')}</p>
 </div>

 <div className="flex flex-col md:flex-row gap-8 items-center justify-center mb-12">
 {/* Visual Pie Representation */}
 <div className="w-48 h-48 rounded-full border-8 border-linear-border relative flex items-center justify-center shadow-lg overflow-hidden shrink-0 bg-linear-surface">
 <div className="text-center z-10 bg-linear-surface/90 p-4 rounded-full backdrop-blur-sm border border-linear-border shadow-sm">
 <span className="block text-3xl font-black text-foreground">{totalPoints}</span>
 ...
 <div className="bento-card bg-background border border-linear-border p-6 text-center">
 <Target className="w-8 h-8 mx-auto text-linear-text-muted mb-3" />
 <p className="text-sm text-linear-text-muted leading-relaxed max-w-xl mx-auto">
 {t('wizard.step4_note')}
 </p>
 </div>
 </div>
