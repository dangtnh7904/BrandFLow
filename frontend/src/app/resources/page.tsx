...
const EBOOKS = [
  {
    ...
    image: '/resources/ai_marketing_cover.png',
    pdfUrl: '/resources/THE_AI_POWERED_SME.pdf',
    pages: 42,
  ...
  },
  {
    ...
    image: '/resources/branding_cover.png',
    pdfUrl: '/resources/BRANDING_MASTERCLASS.pdf',
    pages: 36,
  ...
  },
  {
    ...
    image: '/resources/marketing_plan_cover.png',
    pdfUrl: '/resources/MARKETING_PLAN_MASTERCLASS.pdf',
    pages: 38,
