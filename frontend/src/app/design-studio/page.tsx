...
export default function DesignStudioPage() {
  ...
  return (
    <div className="w-full h-full overflow-y-auto no-scrollbar relative z-10 pb-20 pt-6 px-6 lg:px-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center space-x-3 text-foreground">
          ...
          <div>
            ...
            <p className="text-linear-text-muted mt-1 text-sm font-medium">B2B Visual Asset & Brand Identity Generator</p>
          </div>
        </div>
      </div>

      {/* 3-COLUMN BENTO BOX GRID */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[calc(100vh-160px)] min-h-[800px]">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6 overflow-y-auto no-scrollbar pb-6">
          ...
          >
            <div className="flex items-center mb-5 pb-3 border-b border-linear-border/50">
              ...
              <h2 className="text-sm font-bold text-foreground uppercase tracking-wider">Agent 0: Master DNA</h2>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                <div className="text-[10px] font-bold text-linear-text-muted uppercase mb-1">Core USPs</div>
                <div className="text-xs text-foreground whitespace-pre-line">{masterDNA.usps}</div>
              </div>
              <div>
                <div className="text-[10px] font-bold text-linear-text-muted uppercase mb-1">Target Audience</div>
            ...
            <div className="flex items-center mb-4 mt-2">
              ...
              <h2 className="text-sm font-bold text-foreground">Creative Overrides</h2>
            </div>

            <div className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-linear-text-muted mb-2">Thông điệp bổ sung (Tùy chọn)</label>
                <textarea 
                  rows={4}
                  placeholder="VD: Tôi muốn logo phải bo góc tròn, không dùng màu đỏ..."
              ...
              <div>
                <label className="block text-xs font-semibold text-linear-text-muted mb-2">Định hướng (Creative Direction)</label>
            ...
            >
              {loading ? (
                ...
                <span className="flex items-center text-sm relative z-10">
                  <Palette className="w-4 h-4 mr-2" /> Thiết kế Ngay
                </span>
              )}
            </button>
            <AnimatePresence>
        ...
        <div className="lg:col-span-6 flex flex-col gap-6 overflow-y-auto no-scrollbar pb-6 relative">
           ...
           {!loading && !result && (
              <div className="w-full h-full bento-card p-10 flex flex-col items-center justify-center min-h-[500px]">
                 ...
                 <h3 className="text-xl font-bold text-foreground mb-2">The Canvas</h3>
                 <p className="text-sm text-linear-text-muted text-center max-w-sm">
                    Nhập dữ liệu ở cột bên trái và khởi động Hệ thống AI. Kết quả Mini Brand Guidelines sẽ được trực quan hóa tại đây.
                 </p>
              </div>
           )}
           ...
           {loading && (
              <div className="w-full h-full bento-card p-10 flex flex-col items-center justify-center min-h-[500px] relative overflow-hidden group">
                 ...
                 <h3 className="text-lg font-bold text-cyan-400 animate-pulse drop-shadow-[0_0_8px_rgba(34,211,238,0.6)] z-10 relative">DALL-E 3 Rasterization in Progress...</h3>
                 <p className="text-xs text-linear-text-muted mt-2 max-w-sm text-center z-10 relative">
                   Hệ thống đang cấu trúc màu sắc phong thủy và vẽ tỷ lệ vàng cho Logo. Quá trình mất khoảng 15-30 giây.
                 </p>
              </div>
           )}
           ...
           {!loading && result && (
              ...
              >
                  ...
                  <div className="bento-card p-0 overflow-hidden relative">
                     <div className="p-4 border-b border-linear-border flex justify-between items-center bg-linear-surface/50">
                        <div className="flex items-center font-bold text-sm text-foreground">
                          <Briefcase className="w-4 h-4 text-cyan-500 mr-2" /> Master Logo
                        </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     ...
                     <div className="bento-card p-4 flex flex-col justify-between">
                        <div className="flex justify-between items-center mb-3">
                           <div className="text-xs font-bold text-linear-text-muted uppercase tracking-wider">Color Palette</div>
                     ...
                     <div className="bento-card p-4 flex flex-col justify-between">
                        <div className="flex justify-between items-center mb-3">
                           <div className="text-xs font-bold text-linear-text-muted uppercase tracking-wider">Typography Pair</div>
                  ...
                  <div className="bento-card p-0 overflow-hidden relative">
                     <div className="p-4 border-b border-linear-border flex justify-between items-center bg-linear-surface/50">
                        <div className="flex items-center font-bold text-sm text-foreground">
                          <ImageIcon className="w-4 h-4 text-cyan-500 mr-2" /> Digital App Mockup / Social Media
                        </div>
                     </div>
                  ...
                  <div className="bento-card p-4 relative group overflow-hidden border-cyan-500/20 shadow-[0_0_15px_rgba(6,182,212,0.05)]">
                     <div className="flex bg-linear-surface border border-linear-border rounded-lg p-1">
                        <input 
                           type="text"
                           placeholder="Yêu cầu sửa đổi với AI: Đổi sang màu đỏ ấm hơn..."
                        ...
                        >
                           {revising ? <RefreshCw className="w-3.5 h-3.5 animate-spin mr-1" /> : <RefreshCw className="w-3.5 h-3.5 mr-1" />} Revise
                        </button>
                     </div>
                  </div>
                     ...
                     <Link href="/workspace">
                        <button className="w-full py-5 rounded-2xl flex items-center justify-center font-bold text-white text-lg transition-all overflow-hidden relative group cursor-pointer bg-gradient-to-r from-blue-700 to-cyan-500 hover:from-blue-600 hover:to-cyan-400 border-[rgba(255,255,255,0.1)] border shadow-[0_0_30px_rgba(6,182,212,0.3)] hover:shadow-[0_0_40px_rgba(6,182,212,0.5)]">
                          <span className="flex items-center relative z-10 tracking-wide">
                            ...
                            XUẤT BRAND GUIDELINE QUỐC TẾ (PDF) & ÁP DỤNG
                          </span>
                          <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                        </button>
                     </Link>
                     <p className="text-center text-xs text-linear-text-muted flex items-center justify-center mt-3">
                        <Activity className="w-3.5 h-3.5 mr-1 text-emerald-400" /> Hệ thống BrandFlow sẽ tự động lưu DNA này làm xương sống cho Chiến dịch Marketing
                     </p>
                  </div>
        ...
        {/* ================================================== */}
        <div className="lg:col-span-3 flex flex-col gap-6 overflow-hidden max-h-full">
           <div className="bento-card p-0 flex flex-col h-[600px] border-cyan-500/20 shadow-[0_0_15px_rgba(6,182,212,0.05)] relative overflow-hidden group">
              <div className="p-4 border-b border-linear-border flex justify-between items-center bg-linear-surface/80 backdrop-blur-md shrink-0">
                 <div className="flex items-center">
                   ...
                   <h4 className="font-bold text-sm text-foreground tracking-wide">Agents Cortex</h4>
                 </div>
                 <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" title="System Online"></div>
              </div>

              {/* Visual Nodes UI */}
              <div className="flex-1 bg-slate-50/50 dark:bg-[#020617] p-5 overflow-y-auto no-scrollbar flex flex-col gap-2 relative transition-colors duration-500">
                 
                 {/* Market Agent Node */}
                 <div className={`p-4 rounded-xl border relative overflow-hidden transition-all duration-500 z-10 ${activeAgent === 'Market Agent' ? 'border-cyan-500/50 bg-cyan-500/5 dark:bg-cyan-500/10 shadow-[0_0_20px_rgba(6,182,212,0.15)] scale-105' : 'border-linear-border bg-white/50 dark:bg-slate-900/50 grayscale opacity-80'}`}>
                    <div className="flex items-center justify-between mb-2">
                       <div className="flex items-center">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 transition-colors ${activeAgent === 'Market Agent' ? 'bg-cyan-500 text-white shadow-[0_0_15px_rgba(6,182,212,0.5)]' : 'bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 border border-slate-200 dark:border-slate-700'}`}>
                             <LineChart className="w-4 h-4" />
                          </div>
                          <span className={`font-bold text-sm tracking-wide ${activeAgent === 'Market Agent' ? 'text-cyan-700 dark:text-white' : 'text-slate-500 dark:text-slate-400'}`}>Market Agent</span>
                       </div>
                       {activeAgent === 'Market Agent' && <span className="flex w-2.5 h-2.5 rounded-full bg-cyan-500 dark:bg-cyan-400 animate-ping" />}
                    </div>
                    <div className={`pl-11 text-[11px] font-mono line-clamp-1 h-4 ${activeAgent === 'Market Agent' ? 'text-cyan-600 dark:text-cyan-200/70' : 'text-slate-400 dark:text-slate-500'}`}>
                       {agentLogs.filter(l => l.agent === 'Market Agent').pop()?.text || "Standby for DNA..."}
                    </div>
                 </div>

                 {/* Connector */}
                 <div className="w-0.5 h-6 mx-auto bg-slate-200 dark:bg-slate-800 relative overflow-hidden shrink-0 transition-colors">
                 ...
                 {/* Creative Agent Node */}
                 <div className={`p-4 rounded-xl border relative overflow-hidden transition-all duration-500 z-10 ${activeAgent === 'Creative Agent' ? 'border-indigo-500/50 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-[0_0_20px_rgba(99,102,241,0.15)] scale-105' : 'border-linear-border bg-white/50 dark:bg-slate-900/50 grayscale opacity-80'}`}>
                    <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/10 rounded-full blur-[40px] -mr-10 -mt-10 pointer-events-none" />
                    <div className="flex items-center justify-between mb-2">
                       <div className="flex items-center">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 transition-colors ${activeAgent === 'Creative Agent' ? 'bg-indigo-500 text-white shadow-[0_0_15px_rgba(99,102,241,0.5)]' : 'bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 border border-slate-200 dark:border-slate-700'}`}>
                             <Palette className="w-4 h-4" />
                          </div>
                          <span className={`font-bold text-sm tracking-wide ${activeAgent === 'Creative Agent' ? 'text-indigo-700 dark:text-white' : 'text-slate-500 dark:text-slate-400'}`}>Creative Agent</span>
                       </div>
                       {activeAgent === 'Creative Agent' && <RefreshCw className="w-4 h-4 text-indigo-500 dark:text-indigo-400 animate-spin" />}
                    </div>
                    <div className={`pl-11 text-[11px] font-mono line-clamp-1 h-4 ${activeAgent === 'Creative Agent' ? 'text-indigo-600 dark:text-indigo-200/70' : 'text-slate-400 dark:text-slate-500'}`}>
                 ...
                 <div className={`p-4 rounded-xl border relative overflow-hidden transition-all duration-500 z-10 ${activeAgent === 'Copywriter Agent' ? 'border-amber-500/50 bg-amber-500/5 dark:bg-amber-500/10 shadow-[0_0_20px_rgba(245,158,11,0.15)] scale-105' : 'border-linear-border bg-white/50 dark:bg-slate-900/50 grayscale opacity-80'}`}>
                    <div className="flex items-center justify-between mb-2">
                       <div className="flex items-center">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 transition-colors ${activeAgent === 'Copywriter Agent' ? 'bg-amber-500 text-white shadow-[0_0_15px_rgba(245,158,11,0.5)]' : 'bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 border border-slate-200 dark:border-slate-700'}`}>
                             <PenTool className="w-4 h-4" />
                          </div>
                          <span className={`font-bold text-sm tracking-wide ${activeAgent === 'Copywriter Agent' ? 'text-amber-700 dark:text-white' : 'text-slate-500 dark:text-slate-400'}`}>Copywriter Agent</span>
                       </div>
                       {activeAgent === 'Copywriter Agent' && <Type className="w-4 h-4 text-amber-500 dark:text-amber-400 animate-pulse" />}
                    </div>
                    <div className={`pl-11 text-[11px] font-mono line-clamp-1 h-4 ${activeAgent === 'Copywriter Agent' ? 'text-amber-600 dark:text-amber-200/70' : 'text-slate-400 dark:text-slate-500'}`}>
                       {agentLogs.filter(l => l.agent === 'Copywriter Agent').pop()?.text || "Analyzing Tone..."}
                    </div>
                 </div>

                 {/* Tiny Terminal Footer for "Hacker feel" */}
                 <div className="mt-auto pt-4 border-t border-slate-200 dark:border-slate-800/50 transition-colors">
                    <div className="text-[9px] text-slate-500 dark:text-slate-600 mb-1 flex items-center font-bold">
                       <TerminalSquare className="w-3 h-3 mr-1" /> RAW OUTPUT LOG
                    </div>
                    <div className="h-16 overflow-y-hidden flex flex-col justify-end text-[10px] font-mono text-slate-400 dark:text-slate-500 leading-tight">
                       {agentLogs.slice(-3).map(log => (
                          <div key={log.id} className="truncate">
                             <span className="opacity-50">[{log.time}]</span> <span className={log.type === 'warn' ? 'text-amber-500' : 'text-inherit'}>{log.text}</span>
                          </div>
                       ))}
                    </div>
                 </div>
           ...
           <div className="flex gap-4 h-24">
              <div className="flex-1 bento-card p-3 flex flex-col justify-center items-center relative overflow-hidden group">
                 <div className="text-[10px] text-linear-text-muted font-bold uppercase tracking-widest z-10">Time Saved</div>
              ...
              <div className="flex-1 bento-card p-3 flex flex-col justify-center items-center relative overflow-hidden group">
                 <div className="text-[10px] text-linear-text-muted font-bold uppercase tracking-widest z-10">Cost ROI</div>
