...
export default function HubPage() {
  ...
  const features = [
    {
      id: "daily-content",
      title: t('hub.daily_content'),
      desc: t('hub.daily_desc'),
      icon: PenSquare,
    ...
    {
      id: "design-studio",
      title: t('hub.design_studio'),
      desc: t('hub.design_desc'),
      icon: Palette,
    ...
    {
      id: "workspace",
      title: t('hub.strategic_planning'),
      desc: t('hub.strategic_desc'),
      icon: MessageSquare,
          ...
          <Link href={feature.href} key={feature.id} className="block group">
            ...
            >
              ...
              <div className="mt-8 flex items-center text-sm font-bold text-linear-text-muted group-hover:text-foreground transition-colors">
                <span className="uppercase tracking-widest">{t('hub.launch')}</span>
