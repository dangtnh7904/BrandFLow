...
export default function ActivePlansCard() {
 ...
 <div className="p-2 rounded-full bg-linear-surface/50 border border-linear-border group-hover:bg-cyan-50 transition-colors">
 <ChevronRight className="w-5 h-5 text-linear-text-muted group-hover:text-cyan-600 transition-colors" />
 </div>
 </div>
 ...
 <div key={idx} className="flex items-center justify-between p-3 rounded-2xl bg-linear-surface border border-linear-border group-hover:border-cyan-500/30 transition-colors shadow-sm">
 <div className="flex items-center">
 <div className="w-10 h-10 rounded-xl bg-background border border-linear-border flex items-center justify-center mr-4">
 <BarChart3 className="w-4 h-4 text-linear-text-muted" />
 </div>
 <div>
 ...
 <div className="text-sm font-bold text-foreground">{plan.budget}</div>
